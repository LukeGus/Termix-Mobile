...
export default function CustomKeyboard({ terminalRef, isVisible, keyboardHeight }: CustomKeyboardProps) {
  ...
  return (
    <View style={[styles.keyboard, { height: keyboardHeight }]}>
      ...
      >
        ...
        <View style={styles.keyRow}>
          <KeyboardKey label="Insert" onPress={() => sendSpecialKey('Insert')} />
          <KeyboardKey label="Home" onPress={() => sendSpecialKey('Home')} />
          <KeyboardKey label="PageUp" onPress={() => sendSpecialKey('PageUp')} />
          <KeyboardKey label="Delete" onPress={() => sendSpecialKey('Delete')} />
          <KeyboardKey label="End" onPress={() => sendSpecialKey('End')} />
          <KeyboardKey label="PageDown" onPress={() => sendSpecialKey('PageDown')} />
        </View>
        ...
        <View style={styles.numberRow}>
          <KeyboardKey label="1" onPress={() => sendKey('1')} style={styles.numberKey} />
          <KeyboardKey label="2" onPress={() => sendKey('2')} style={styles.numberKey} />
          <KeyboardKey label="3" onPress={() => sendKey('3')} style={styles.numberKey} />
          <KeyboardKey label="4" onPress={() => sendKey('4')} style={styles.numberKey} />
          <KeyboardKey label="5" onPress={() => sendKey('5')} style={styles.numberKey} />
          <KeyboardKey label="6" onPress={() => sendKey('6')} style={styles.numberKey} />
          <KeyboardKey label="7" onPress={() => sendKey('7')} style={styles.numberKey} />
          <KeyboardKey label="8" onPress={() => sendKey('8')} style={styles.numberKey} />
          <KeyboardKey label="9" onPress={() => sendKey('9')} style={styles.numberKey} />
          <KeyboardKey label="0" onPress={() => sendKey('0')} style={styles.numberKey} />
        </View>

        <View style={styles.separator} />

        {/* Row 5: Top Row Characters */}
        <View style={styles.keyRow}>
        ...
        {/* Row 8: Essential Keys */}
        <View style={styles.keyRow}>
          <KeyboardKey label="Enter" onPress={() => sendSpecialKey('Enter')} />
          <KeyboardKey label="Backspace" onPress={() => sendSpecialKey('Backspace')} />
        </View>

        <View style={styles.separator} />

        {/* Row 9: Terminal Shortcuts */}
        <View style={styles.keyRow}>
